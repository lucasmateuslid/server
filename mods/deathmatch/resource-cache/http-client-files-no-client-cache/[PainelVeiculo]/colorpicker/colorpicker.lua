...
colorPicker = {
	...
	constructor = function( info )
		...
		colorPicker.GUI.selectWindow = guiCreateWindow(screenW - info.selectWindow.width, (screenH - info.selectWindow.height) / 1.2,
		                                        info.selectWindow.width, info.selectWindow.height, "Escolha uma cor", false)
		...
		colorPicker.GUI.historyLabel = guiCreateLabel(info.selectWindow.historyX, info.selectWindow.historyY,
		                                       150, 15, "Cores usadas", false, colorPicker.GUI.selectWindow)
											   
		colorPicker.GUI.noteLabel = guiCreateLabel(info.selectWindow.noteX, info.selectWindow.noteY,
		                                       190, 15, "Clique fora do painel para fechar", false, colorPicker.GUI.selectWindow)
		...
		checkColor3 = guiCreateCheckBox(info.selectWindow.ra3X, info.selectWindow.ra3Y,
												75, 15, "Faróis", true, false, colorPicker.GUI.selectWindow)
