function abaOuro()
	...
	if localPlayer:getData("Vip_Bronze") ~= "Sim" then
		...
		if cursorPosition(x*323, y*249, x*90, y*35) then
			drawBorde(x*323, y*249, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*323, y*298, x*90, y*35) then
			drawBorde(x*323, y*298, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*323, y*347, x*90, y*35) then
			drawBorde(x*323, y*347, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*323, y*396, x*90, y*35) then
			drawBorde(x*323, y*396, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*430, y*249, x*90, y*35) then
			drawBorde(x*430, y*249, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*430, y*298, x*90, y*35) then
			drawBorde(x*430, y*298, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*430, y*347, x*90, y*35) then
			drawBorde(x*430, y*347, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*540, y*249, x*90, y*35) then
			drawBorde(x*540, y*249, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*540, y*298, x*90, y*35) then
			drawBorde(x*540, y*298, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*540, y*347, x*90, y*35) then
			drawBorde(x*540, y*347, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*640, y*249, x*90, y*35) then
			drawBorde(x*640, y*249, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*640, y*298, x*90, y*35) then
			drawBorde(x*640, y*298, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*640, y*347, x*90, y*35) then
			drawBorde(x*640, y*347, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*840, y*249, x*90, y*35) then
			drawBorde(x*840, y*249, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*840, y*298, x*90, y*35) then
			drawBorde(x*840, y*298, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*840, y*347, x*90, y*35) then
			drawBorde(x*840, y*347, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
		...
		if cursorPosition(x*740, y*249, x*90, y*35) then
			drawBorde(x*740, y*249, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
			drawBorde(x*740, y*249, x*90, y*35, tocolor(11,11,11,AlphaVip[1]))
		end
		dxDrawText("PF Agente", x*750, y*256, x*111, y*21, tocolor(255,255,255,AlphaVip[1]), 1.00, fontsVip.robotoVip[5], "left", "top")
		if cursorPosition(x*740, y*298, x*90, y*35) then
			drawBorde(x*740, y*298, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
			drawBorde(x*740, y*298, x*90, y*35, tocolor(11,11,11,AlphaVip[1]))
		end
		dxDrawText("PF Fem", x*750, y*305, x*111, y*21, tocolor(255,255,255,AlphaVip[1]), 1.00, fontsVip.robotoVip[5], "left", "top")
		if cursorPosition(x*740, y*347, x*90, y*35) then
			drawBorde(x*740, y*347, x*90, y*35, tocolor(58,91,154,AlphaVip[1]))
		else
			drawBorde(x*740, y*347, x*90, y*35, tocolor(11,11,11,AlphaVip[1]))
		end
		dxDrawText("PF Superior", x*750, y*354, x*111, y*21, tocolor(255,255,255,AlphaVip[1]), 1.00, fontsVip.robotoVip[5], "left", "top")
		dxDrawText("Fardas PF", x*750, y*225, x*173, y*21, tocolor(255,255,255,AlphaVip[2]), 1.00, fontsVip.robotoVip[5], "left", "top")
	...
	if cursorPosition(x*790, y*148, x*127, y*38) or Select == "Ouro" then
		drawBorde(x*790, y*148, x*127, y*38, tocolor(58,91,154,AlphaVip[1]))
	else
