...
function limpochat()
	...
	dxDrawText(""..nome.." #ffffffLimpou o #00a1ffChat", x*170, y*pox, x*236, y*238, tocolor(255, 255, 255, 255), x*1, "default-bold", "center", "center", false, false, true, true, false)
end 
...
function animclose ()
	...
	dxDrawText(""..nome.." #ffffffLimpou o #00a1ffChat", x*170, y*pox, x*236, y*238, tocolor(255, 255, 255, fade), x*1, "default-bold", "center", "center", false, false, true, true, false)
end
