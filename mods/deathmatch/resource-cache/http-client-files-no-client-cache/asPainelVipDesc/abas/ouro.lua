function abaOuro()
	...
	if localPlayer:getData("Vip_Ouro") ~= "Sim" then
		...
		dxDrawText("Você não é Vip Ouro", x*565, y*370, x*62, y*28, tocolor(255,255,255,AlphaVip[1]), 1.00, fontsVip.robotoVip[4], "left", "top")
	else
		drawBorde(x*297, y*222, x*772, y*379, tocolor(21,21,21,AlphaVip[2]))
		...
		dxDrawText("Veiculo |", x*370, y*403, x*111, y*21, tocolor(255,255,255,AlphaVip[1]), 1.00, fontsVip.robotoVip[5], "left", "top")
		...
		dxDrawText("Kit Armas |", x*370, y*550, x*111, y*21, tocolor(255,255,255,AlphaVip[1]), 1.00, fontsVip.robotoVip[5], "left", "top")
		...
		dxDrawText("Kit Armas ||", x*568, y*256, x*111, y*21, tocolor(255,255,255,AlphaVip[1]), 1.00, fontsVip.robotoVip[5], "left", "top")
		...
		dxDrawText("Kit Vida 70%", x*568, y*354, x*111, y*21, tocolor(255,255,255,AlphaVip[1]), 1.00, fontsVip.robotoVip[5], "left", "top")
		...
		dxDrawText("Colete 40%", x*568, y*403, x*111, y*21, tocolor(255,255,255,AlphaVip[1]), 1.00, fontsVip.robotoVip[5], "left", "top")
		...
		dxDrawText("Estilo Anda |", x*568, y*452, x*111, y*21, tocolor(255,255,255,AlphaVip[1]), 1.00, fontsVip.robotoVip[5], "left", "top")
