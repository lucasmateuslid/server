...
setTimer(function()
    windows = {
        ...
        ['Configuração'] = {
            ...
            {x * 1165, y * 380, x * 1305, y * 405, 'texto', 'brr@icloud.com', 1, 'default-bold', 'left', tocolor(255, 255, 255, alpha)},
            ...
            {x * 1106, y * 348, x * 55, y * 55, 'imagem', ':[BRR]Login/assets//${avatar}.png', tocolor(255, 255, 255, alpha)},
        ...
        ['Chamando'] = {
            {x * 1096, y * 236, x * 228.51, y * 495.11, 'imagem', 'Files/Imagens/interface.png', tocolor(41, 41, 41, alpha)},
            {x * 1135, y * 309, x * 150, y * 150, 'imagem', ':[BRR]Login/assets//${avatarfdp}.png', tocolor(255, 255, 255, alpha)},
...
function dxDraw()
    ...
    elseif (window == 'Conversa Tinder') then
        ...
        if window ~= 'Contatos' then
            ...
            dxDrawText('Samu [192]', x * 1102, y * 414, x * 1288, y * 432, tocolor(200, 200, 200, alpha), 1.00, 'default', 'left', 'top', false, false, false, false, false)
