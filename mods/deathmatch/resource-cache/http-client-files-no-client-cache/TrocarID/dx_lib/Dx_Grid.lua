...
local NATIVE_RESOLUTION		=	{ 1920, 1080 } -- put your screen resolution here to fit the gridlists to all resolutions (ex: { 1366, 768 } )
            ...
            for index, data in ipairs ( dxGridW.items ) do
                ...
                if data.vis then
                    ...
                    if data.se and data.se <= data.r and data.se >= seeFrom and data.se <= seeTo then
                        ...
                        dxDrawRectangle ( data.x, ( 30 % data.h ) + y2, data.w, 27, tocolor ( 0, 0, 0, 200 ), data.pg );
                    end
