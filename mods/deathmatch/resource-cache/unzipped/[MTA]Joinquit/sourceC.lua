...
addEventHandler('onClientPlayerChangeNick', root,
	...
	sendClientMessage("#FFFFFF"..oldNick.."#FFFFFF mudou o nome para "..newNick..".", 255, 100, 100, false, 5)
	end
)
...
addEventHandler('onClientPlayerJoin', root,
	function()
		sendClientMessage("#FFFFFF"..getPlayerName(source).." #FFFFFFEsta chegando na cidade.", 255, 100, 100, false, 5)
	end
)